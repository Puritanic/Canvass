                            ...
                            <table class="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td style="line-height:0;">
                                  <a target="_blank" style="text-decoration:none;" href="https://canvass-dev.herokuapp.com/">
                                    <img src="images/logo.png" border="0" style="font:bold 12px/12px Arial, Helvetica, sans-serif; color:#606060;" align="left"
                                      vspace="0" hspace="0" width="113" height="12" alt="Canvass app" />
                                  </a>
                                </td>
                              </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td data-color="text" data-size="size navigation" data-min="10" data-max="22" data-link-style="text-decoration:none; color:#888;"
                                  ...
                                  <a target="_blank" style="text-decoration:none; color:#888;" href="#">About</a> &nbsp; &nbsp;
            ...
            <tr>
              <td data-bgcolor="bg-module" bgcolor="#eaeced">
                <table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="img-flex">
                      <img src="images/img-01.jpg" style="vertical-align:top;" width="600" height="306" alt="" />
                    </td>
                  </tr>
                  <tr>
